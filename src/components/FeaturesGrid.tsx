                        ...
                        >
                            ...
                            <div className="flex-1 w-full px-0 md:px-0 mb-6 md:mb-0">
                                <div className="relative group">
                                    ...
                                    {/* Image Container */}
                                    <div className="relative rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-sm md:shadow-xl border border-gray-100 bg-white aspect-[4/3] transform transition-transform duration-500 group-hover:-translate-y-2">
                                        <Image
                                            src={feature.image}
                                            alt={feature.badge}
                                            fill
