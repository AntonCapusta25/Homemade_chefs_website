                        ...
                        <div className="flex items-center gap-6 text-white/90 border-t border-white/20 pt-6">
                            <div className="flex items-center gap-3">
                                {post.author_avatar ? (
                                    ...
                                    <div className="w-12 h-12 rounded-full bg-[#F47A44] flex items-center justify-center text-white font-bold text-2xl border-2 border-white">
